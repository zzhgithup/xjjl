 ...
 * @InterfaceName XZOtherEventsDao
 * @Description TODO
 */
@Repository
@Mapper
public interface XZOtherEventsDao {
    /*
     * @Author zzh
     ...
     * @description TODO
     */
    ArrayList<OtherEvents> getxzqtsjbycond(@Param("banci") String banci,@Param("username") String username,@Param("starttime") String starttime,@Param("endtime") String endtime);
}
