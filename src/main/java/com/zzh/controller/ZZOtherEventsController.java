...
import com.zzh.service.impl.ZZOtherEventsServiceImpl;
 ...
 * @ClassName ZZOtherEventsController
 * @Description TODO
 */
@RestController
@CrossOrigin
@RequestMapping("/zz")
public class ZZOtherEventsController {

    @Autowired
    ZZOtherEventsServiceImpl zzOtherEventsService;

    Logger logger= LoggerFactory.getLogger(getClass());
    @GetMapping("/getotherevents")
    public String getotherevents(){
        logger.info("请求获取所有其他事件记录");
        String result=zzOtherEventsService.getotherevents();
    ...
    public String addotherevent(@PathVariable("qtsjtime") String qtsjtime,@PathVariable("qtsjpost") String qtsjpost,@PathVariable("qtsjclass") String qtsjclass,@PathVariable("qtsjname") String qtsjname){
        ...
        String addpatrolrecord = zzOtherEventsService.addotherevent(qtsjtime, qtsjpost, qtsjclass, qtsjname);
    ...
    public String delotherevent(@PathVariable("date") String date){
        ...
        String result=zzOtherEventsService.delotherevent(date);
    ...
    public String updothereventsjms(@PathVariable("sjms") String sjms,@PathVariable("date") String date){
        ...
        String result=zzOtherEventsService.updothereventsjms(sjms,date);
    ...
    public String updothereventsxjbh(@PathVariable("sxjbh") String sxjbh,@PathVariable("date") String date){
        ...
        String result=zzOtherEventsService.updothereventsxjbh(sxjbh,date);
    ...
    public String getqtsjInfoByDate(@PathVariable("date") String date){
        ...
        String result=zzOtherEventsService.getqtsjInfoByDate(date);
    ...
    public String updqtsj(@PathVariable("date") String date){
        ...
        String result=zzOtherEventsService.updqtsj(date);
        logger.info("确认执行状态成功");
        return result;
    }

    @GetMapping("getzzqtsjbycond/{banci}/{username}/{starttime}/{endtime}")
    public String getzzqtsjbycond(@PathVariable("banci") String banci,@PathVariable("username") String username,@PathVariable("starttime") String starttime,@PathVariable("endtime") String endtime){
        logger.info("根据条件查询值站其他事件记录");
        String name = null;
        try {
        ...
        String result=zzOtherEventsService.getzzqtsjbycond(banci,name,starttime,endtime);
        logger.info("根据条件查询值站其他事件记录成功");
        return result;
    }
}
